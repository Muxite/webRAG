        ...
        "leaves": [
            {
                ...
                "instruction": (
                    ...
                    "run_python to check the worked examples above ('a@b.co' -> True, "
                    "'user@example..com' -> False, 'user@example.c0m' -> False), then "
                    "construct SEVERAL MORE addresses of your own -- valid and invalid -- "
                    "each violating exactly one of the rules above (local leading/trailing/"
                    "consecutive dot; domain leading/trailing/consecutive dot; domain label "
                    "leading/trailing hyphen; domain with no dot at all; TLD too short; TLD "
                    "with a digit; TLD with a hyphen) and confirm each behaves as the rule "
                    "predicts -- inventing your own strings here (rather than reusing the "
                    "worked examples) is what actually tests whether your logic generalizes. "
