...
if TYPE_CHECKING:
    from ideaengine.idea_dag import IdeaDag, IdeaNode

from ideaengine.agent_io import AgentIO
from ideaengine.idea_policies.base import EvaluationPolicy, DetailKey
...
class LlmEvaluationPolicy(EvaluationPolicy):
    ...
    async def evaluate(self, graph: IdeaDag, node_id: str) -> float:
        ...
        from ideaengine.idea_policies.action_constants import NodeDetailsExtractor, ActionResultKey
    ...
    def _build_messages(self, graph: IdeaDag, node: IdeaNode) -> List[Dict[str, str]]:
        ...
        from ideaengine.idea_policies.action_constants import PromptBuilder
