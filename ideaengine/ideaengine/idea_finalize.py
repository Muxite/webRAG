...
from ideaengine.idea_policies.base import DetailKey
from ideaengine.idea_policies.action_constants import NodeDetailsExtractor
from ideaengine.prompt_builder import FinalPromptBuilder
...
def _collect_leaf_results_fallback(graph: IdeaDag) -> list:
    from ideaengine.idea_policies.base import IdeaNodeStatus, IdeaActionType
...
def _build_fallback_deliverable(graph: IdeaDag, merged: list) -> str:
    ...
    """
    from ideaengine.idea_policies.base import IdeaActionType, IdeaNodeStatus
    from ideaengine.idea_policies.action_constants import ActionResultExtractor
...
def _build_node_summary_table(graph: IdeaDag) -> str:
    from ideaengine.idea_policies.action_constants import ActionResultKey, ActionResultExtractor
    from ideaengine.idea_policies.base import IdeaActionType
