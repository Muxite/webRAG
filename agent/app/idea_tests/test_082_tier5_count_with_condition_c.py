...
SELF-VERIFY (throwaway snippet — delete after):
    from agent.app.idea_tests.test_082_tier5_count_with_condition_c import (
...
ENTITIES: List[Dict[str, Any]] = [
    {
        ...
        # "Sepik River" redirects to the real canonical title "Sepik" (confirmed live via the
        # MediaWiki API) -- a correctly-grounded visit can land on either URL.
        "slug_rx":   r"wiki/sepik(?:_river)?(?![a-z])",
    },
    {
        "key":       "atbara",
        "name":      "Atbara River",
