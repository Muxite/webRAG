"""
Test 304: Mechanism suite — stale-vs-current source conflict requiring an explicit VERIFY hop
...
How this differs from the existing contradiction tasks (deliberately NOT a clone):
  ...
  * test_304 (this task): the conflict is PAGE-vs-PAGE and TEMPORAL. A specific live URL is
