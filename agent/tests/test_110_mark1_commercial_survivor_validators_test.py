...
def test_ungrounded_correct_value_gates_to_zero():
    ...
    assert t.validate_keystone_valves(r, ungrounded_obs)["score"] == 0.0
    assert t.validate_keystone_valves(r, ungrounded_obs)["passed"] is False
    ...
    scores = [
        ...
        t.validate_keystone_valves(r, ungrounded_obs)["score"],
