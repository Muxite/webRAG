...
def test_ungrounded_correct_value_gates_to_zero():
    ...
    of Jan Koller as the argmax must collapse the keystone gate (and everything gated on it) to 0."""
    r = _r(_FULL_SINGLE)
    ...
    assert t.validate_winner_ratio(r, ungrounded_obs)["score"] == 0.0
    ...
    # though the raw text names all five players, closing the "parametric recall" leak.
    ...
    scores = [
        ...
        t.validate_winner_ratio(r, ungrounded_obs)["score"],
